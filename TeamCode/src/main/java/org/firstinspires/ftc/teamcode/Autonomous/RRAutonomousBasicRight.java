...
public class RRAutonomousBasicRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence advancedTrajTryRight = drive.trajectorySequenceBuilder(new Pose2d(-61.70, -33.0, Math.toRadians(180.0)))
                .strafeLeft(3.0)
                .lineToConstantHeading(new Vector2d(-10.0, -32.5)) // -12 -33
        ...
        TrajectorySequence stackTraj1Right = drive.trajectorySequenceBuilder(/*new Pose2d(-8.5, -25.83, Math.toRadians(0.0))*/ advancedTrajTryRight.end())
                .forward(6.0)
        ...
        TrajectorySequence stackTrajPole1 = drive.trajectorySequenceBuilder(stackTraj1Right.end())
                .lineToLinearHeading(new Pose2d(-14, -34.1, Math.toRadians(180)))
        ...
        TrajectorySequence forwardPole1 = drive.trajectorySequenceBuilder(stackTraj1Right.end())
                .back(1.0)
                .build();

        TrajectorySequence leftPark = drive.trajectorySequenceBuilder(/*new Pose2d(-35.70, 0.0, Math.toRadians(0.0))*/ advancedTrajTryRight.end())
                .forward(2.0)
                .strafeRight(14.0)
                .build();

        TrajectorySequence centerPark = drive.trajectorySequenceBuilder(/*new Pose2d(-35.70, 0.0, Math.toRadians(0.0))*/ advancedTrajTryRight.end())
                .strafeLeft(11)
                .build();

        TrajectorySequence rightPark = drive.trajectorySequenceBuilder(/*new Pose2d(-35.70, 0.0, Math.toRadians(0.0))*/ advancedTrajTryRight.end())
                .forward(2.0)
                .strafeLeft(32.5)
                .build();
